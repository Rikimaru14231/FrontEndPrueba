...
export class CreaeditaestacionamientoComponent {
  ...
  aceptar(): void {
    if (this.form.valid) {
      ...
      this.estacionamiento.horarioperativoEstacionamiento = this.form.value.hoperativo;
      this.estacionamiento.ventajasEstacionamiento = this.form.value.ventaja;
      this.estacionamiento.desventajasEstacionamiento = this.form.value.desventaja;
      this.estacionamiento.testacionamiento.descripcionTestacionamiento = this.form.value.te;
      if (this.edicion) {
    ...
    if (this.edicion) {
      this.eS.listId(this.id).subscribe((data) => {
        this.form = new FormGroup({
          ...
          te: new FormControl(data.testacionamiento),
        });
      });
    }
  }
